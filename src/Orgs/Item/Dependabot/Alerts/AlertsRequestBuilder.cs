...
namespace Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts
{
    ...
    public partial class AlertsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AlertsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/dependabot/alerts{?after*,artifact_registry_url*,before*,direction*,ecosystem*,epss_percentage*,first*,has*,last*,package*,package_registry*,per_page*,scope*,severity*,sort*,state*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts.AlertsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AlertsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/dependabot/alerts{?after*,artifact_registry_url*,before*,direction*,ecosystem*,epss_percentage*,first*,has*,last*,package*,package_registry*,per_page*,scope*,severity*,sort*,state*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
            ...
            /// <summary>The direction to sort the results by.</summary>
            [QueryParameter("direction")]
            public global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts.GetDirectionQueryParameterType? DirectionAsGetDirectionQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The scope of the vulnerable dependency. If specified, only alerts with this scope will be returned.</summary>
            [QueryParameter("scope")]
            public global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts.GetScopeQueryParameterType? ScopeAsGetScopeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The property by which to sort the results.`created` means when the alert was created.`updated` means when the alert&apos;s state last changed.`epss_percentage` sorts alerts by the Exploit Prediction Scoring System (EPSS) percentage.</summary>
            [QueryParameter("sort")]
            public global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts.GetSortQueryParameterType? SortAsGetSortQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AlertsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Dependabot.Alerts.AlertsRequestBuilder.AlertsRequestBuilderGetQueryParameters>
        {
        }
    }
}
