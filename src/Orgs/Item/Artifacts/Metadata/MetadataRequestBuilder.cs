...
using System;
namespace Soenneker.GitHub.OpenApiClient.Orgs.Item.Artifacts.Metadata
{
    /// <summary>
    /// Builds and executes requests for operations under \orgs\{org}\artifacts\metadata
    /// </summary>
    ...
    public partial class MetadataRequestBuilder : BaseRequestBuilder
    {
        ...
        public MetadataRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/artifacts/metadata", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Artifacts.Metadata.MetadataRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MetadataRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/orgs/{org}/artifacts/metadata", rawUrl)
        {
        }
    }
}
