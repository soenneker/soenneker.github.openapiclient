...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Thread_subject? Subject { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Thread_subject Subject { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.ThreadObject"/> and sets the default values.
        /// </summary>
        public ThreadObject()
        {
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.ThreadObject CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.ThreadObject();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "subject", n => { Subject = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Thread_subject>(global::Soenneker.GitHub.OpenApiClient.Models.Thread_subject.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Thread_subject>("subject", Subject);
