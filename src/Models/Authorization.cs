...
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Authorization_app? App { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Authorization_app App { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.ScopedInstallation? Installation { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.ScopedInstallation Installation { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Authorization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Authorization();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "app", n => { App = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Authorization_app>(global::Soenneker.GitHub.OpenApiClient.Models.Authorization_app.CreateFromDiscriminatorValue); } },
                { "created_at", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                { "expires_at", n => { ExpiresAt = n.GetDateTimeOffsetValue(); } },
                { "fingerprint", n => { Fingerprint = n.GetStringValue(); } },
                { "hashed_token", n => { HashedToken = n.GetStringValue(); } },
                { "id", n => { Id = n.GetLongValue(); } },
                { "installation", n => { Installation = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.ScopedInstallation>(global::Soenneker.GitHub.OpenApiClient.Models.ScopedInstallation.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Authorization_app>("app", App);
            writer.WriteDateTimeOffsetValue("created_at", CreatedAt);
            writer.WriteDateTimeOffsetValue("expires_at", ExpiresAt);
            writer.WriteStringValue("fingerprint", Fingerprint);
            writer.WriteStringValue("hashed_token", HashedToken);
            writer.WriteLongValue("id", Id);
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.ScopedInstallation>("installation", Installation);
