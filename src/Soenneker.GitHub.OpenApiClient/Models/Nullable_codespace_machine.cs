...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Nullable_codespace_machine : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine_prebuild_availability? PrebuildAvailability { get; set; }
        /// <summary>How much storage is available to the codespace.</summary>
        public int? StorageInBytes { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine"/> and sets the default values.
        /// </summary>
        public Nullable_codespace_machine()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "prebuild_availability", n => { PrebuildAvailability = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine_prebuild_availability>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_codespace_machine_prebuild_availability>("prebuild_availability", PrebuildAvailability);
