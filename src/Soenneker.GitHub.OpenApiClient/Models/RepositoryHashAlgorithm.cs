...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class RepositoryHashAlgorithm : IAdditionalDataHolder, IParsable
    {
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.RepositoryHashAlgorithm CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.RepositoryHashAlgorithm();
        }
        /// <summary>
