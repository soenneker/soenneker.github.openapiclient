...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Job_1 : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Job_1_conclusion? Conclusion { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Job_1_status? Status { get; set; }
        /// <summary>Steps in this job.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_steps>? Steps { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_steps> Steps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Job_1"/> and sets the default values.
        /// </summary>
        public Job_1()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Job_1"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Job_1 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Job_1();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "conclusion", n => { Conclusion = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_conclusion>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_status>(); } },
                { "steps", n => { Steps = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_steps>(global::Soenneker.GitHub.OpenApiClient.Models.Job_1_steps.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_conclusion>("conclusion", Conclusion);
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_status>("status", Status);
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Job_1_steps>("steps", Steps);
