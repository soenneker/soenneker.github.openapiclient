...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Campaign_summary : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary_alert_stats? AlertStats { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary_alert_stats AlertStats { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Simple_user>? Managers { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Simple_user> Managers { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alert_stats", n => { AlertStats = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary_alert_stats>(global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary_alert_stats.CreateFromDiscriminatorValue); } },
                ...
                { "managers", n => { Managers = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Simple_user>(global::Soenneker.GitHub.OpenApiClient.Models.Simple_user.CreateFromDiscriminatorValue)?.AsList(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "number", n => { Number = n.GetIntValue(); } },
                { "published_at", n => { PublishedAt = n.GetDateTimeOffsetValue(); } },
                { "state", n => { State = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Campaign_state>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Campaign_summary_alert_stats>("alert_stats", AlertStats);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Simple_user>("managers", Managers);
            writer.WriteStringValue("name", Name);
            writer.WriteIntValue("number", Number);
            writer.WriteDateTimeOffsetValue("published_at", PublishedAt);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Campaign_state>("state", State);
