...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class UsersGetAuthenticated200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.UsersGetAuthenticated200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("user_view_type")?.GetStringValue();
            var result = new global::Soenneker.GitHub.OpenApiClient.Models.UsersGetAuthenticated200();
