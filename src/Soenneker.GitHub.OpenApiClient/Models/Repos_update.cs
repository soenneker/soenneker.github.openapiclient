...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Repos_update : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_message? MergeCommitMessage { get; set; }
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_title? MergeCommitTitle { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_security_and_analysis? SecurityAndAnalysis { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_security_and_analysis SecurityAndAnalysis { get; set; }
#endif
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_message? SquashMergeCommitMessage { get; set; }
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_title? SquashMergeCommitTitle { get; set; }
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_visibility? Visibility { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Repos_update"/> and sets the default values.
        /// </summary>
        public Repos_update()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Repos_update"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Repos_update CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Repos_update();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "merge_commit_message", n => { MergeCommitMessage = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_message>(); } },
                { "merge_commit_title", n => { MergeCommitTitle = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_title>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "private", n => { Private = n.GetBoolValue(); } },
                { "security_and_analysis", n => { SecurityAndAnalysis = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_security_and_analysis>(global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_security_and_analysis.CreateFromDiscriminatorValue); } },
                { "squash_merge_commit_message", n => { SquashMergeCommitMessage = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_message>(); } },
                { "squash_merge_commit_title", n => { SquashMergeCommitTitle = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_title>(); } },
                { "use_squash_pr_title_as_default", n => { UseSquashPrTitleAsDefault = n.GetBoolValue(); } },
                { "visibility", n => { Visibility = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_visibility>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_message>("merge_commit_message", MergeCommitMessage);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_merge_commit_title>("merge_commit_title", MergeCommitTitle);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("private", Private);
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_security_and_analysis>("security_and_analysis", SecurityAndAnalysis);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_message>("squash_merge_commit_message", SquashMergeCommitMessage);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_squash_merge_commit_title>("squash_merge_commit_title", SquashMergeCommitTitle);
            writer.WriteBoolValue("use_squash_pr_title_as_default", UseSquashPrTitleAsDefault);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Repos_update_visibility>("visibility", Visibility);
