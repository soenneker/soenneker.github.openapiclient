...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Issue_search_result_item : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_labels>? Labels { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_labels> Labels { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_pull_request? PullRequest { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_pull_request PullRequest { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item"/> and sets the default values.
        /// </summary>
        public Issue_search_result_item()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "labels", n => { Labels = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_labels>(global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_labels.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "pull_request", n => { PullRequest = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_pull_request>(global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_pull_request.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_labels>("labels", Labels);
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Issue_search_result_item_pull_request>("pull_request", PullRequest);
