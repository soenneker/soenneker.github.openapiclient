...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.ImportProjectChoicesItem>? ProjectChoices { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.ImportProjectChoicesItem> ProjectChoices { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.ImportStatus? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Import"/> and sets the default values.
        /// </summary>
        public Import()
        {
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Import CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Import();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "project_choices", n => { ProjectChoices = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.ImportProjectChoicesItem>(global::Soenneker.GitHub.OpenApiClient.Models.ImportProjectChoicesItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "push_percent", n => { PushPercent = n.GetIntValue(); } },
                { "repository_url", n => { RepositoryUrl = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.ImportStatus>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.ImportProjectChoicesItem>("project_choices", ProjectChoices);
            writer.WriteIntValue("push_percent", PushPercent);
            writer.WriteStringValue("repository_url", RepositoryUrl);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.ImportStatus>("status", Status);
