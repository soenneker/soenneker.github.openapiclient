...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers()
        {
            AdditionalData = new Dictionary<string, object>();
            Mode = global::Soenneker.GitHub.OpenApiClient.Models.CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers_mode.ALWAYS;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.CodeSecurityConfigurationSecretScanningDelegatedBypassOptions_reviewers();
        }
        /// <summary>
