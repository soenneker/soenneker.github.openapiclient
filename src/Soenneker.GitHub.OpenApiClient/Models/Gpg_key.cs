...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Gpg_key : IAdditionalDataHolder, IParsable
    {
...
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_emails>? Emails { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_emails> Emails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_subkeys>? Subkeys { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_subkeys> Subkeys { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key"/> and sets the default values.
        /// </summary>
        public Gpg_key()
        {
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "emails", n => { Emails = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_emails>(global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_emails.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "subkeys", n => { Subkeys = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_subkeys>(global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_subkeys.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_emails>("emails", Emails);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Gpg_key_subkeys>("subkeys", Subkeys);
