...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Dependency_graph_spdx_sbom_sbom_packages : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages_externalRefs>? ExternalRefs { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages_externalRefs> ExternalRefs { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages"/> and sets the default values.
        /// </summary>
        public Dependency_graph_spdx_sbom_sbom_packages()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "externalRefs", n => { ExternalRefs = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages_externalRefs>(global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages_externalRefs.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Dependency_graph_spdx_sbom_sbom_packages_externalRefs>("externalRefs", ExternalRefs);
