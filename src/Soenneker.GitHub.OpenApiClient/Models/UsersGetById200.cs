...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class UsersGetById200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.UsersGetById200"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.UsersGetById200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("user_view_type")?.GetStringValue();
            var result = new global::Soenneker.GitHub.OpenApiClient.Models.UsersGetById200();
