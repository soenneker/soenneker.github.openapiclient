...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class DependabotAlertWithRepositoryDependency : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.DependabotAlertWithRepositoryDependency"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.DependabotAlertWithRepositoryDependency CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.DependabotAlertWithRepositoryDependency();
        }
        /// <summary>
