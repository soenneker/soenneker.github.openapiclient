...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Organization_programmatic_access_grant : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_repository_selection? RepositorySelection { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant"/> and sets the default values.
        /// </summary>
        public Organization_programmatic_access_grant()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "permissions", n => { Permissions = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_permissions>(global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_permissions.CreateFromDiscriminatorValue); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "repository_selection", n => { RepositorySelection = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_repository_selection>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_permissions>("permissions", Permissions);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Organization_programmatic_access_grant_repository_selection>("repository_selection", RepositorySelection);
