...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class EnvironmentProtectionRulesItemAnyOf2ReviewersItemReviewer : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.EnvironmentProtectionRulesItemAnyOf2ReviewersItemReviewer"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.EnvironmentProtectionRulesItemAnyOf2ReviewersItemReviewer CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var result = new global::Soenneker.GitHub.OpenApiClient.Models.EnvironmentProtectionRulesItemAnyOf2ReviewersItemReviewer();
