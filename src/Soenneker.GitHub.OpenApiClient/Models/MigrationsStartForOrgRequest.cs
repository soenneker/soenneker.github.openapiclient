...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class MigrationsStartForOrgRequest : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequestExcludeItem?>? Exclude { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequestExcludeItem?> Exclude { get; set; }
#endif
        /// <summary>Indicates whether attachments should be excluded from the migration (to reduce migration archive file size).</summary>
        ...
        /// <summary>Indicates whether projects owned by the organization or users should be excluded. from the migration.</summary>
        public bool? ExcludeOwnerProjects { get; set; }
        /// <summary>Indicates whether releases should be excluded from the migration (to reduce migration archive file size).</summary>
        public bool? ExcludeReleases { get; set; }
        /// <summary>Indicates whether repositories should be locked (to prevent manipulation) while migrating data.</summary>
        ...
        /// <summary>A list of arrays indicating which repositories should be migrated.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "exclude", n => { Exclude = n.GetCollectionOfEnumValues<global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequestExcludeItem>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<global::Soenneker.GitHub.OpenApiClient.Models.MigrationsStartForOrgRequestExcludeItem>("exclude", Exclude);
