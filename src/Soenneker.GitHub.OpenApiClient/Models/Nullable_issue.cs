...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Nullable_issue : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels>? Labels { get; set; }
#nullable restore
#else
        public List<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels> Labels { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_pull_request? PullRequest { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_pull_request PullRequest { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_state_reason? StateReason { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue"/> and sets the default values.
        /// </summary>
        public Nullable_issue()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "labels", n => { Labels = n.GetCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels>(global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "pull_request", n => { PullRequest = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_pull_request>(global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_pull_request.CreateFromDiscriminatorValue); } },
                ...
                { "state_reason", n => { StateReason = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_state_reason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels>("labels", Labels);
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_pull_request>("pull_request", PullRequest);
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_state_reason>("state_reason", StateReason);
        ...
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1"/>, <see cref="global::Soenneker.GitHub.OpenApiClient.Models.UnionBranch"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Nullable_issue_labels : IComposedTypeWrapper, IParsable
        {
            /// <summary>Composed type representation for type <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1? NullableIssueLabelsMember1 { get; set; }
#nullable restore
#else
            public global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1 NullableIssueLabelsMember1 { get; set; }
#endif
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue.Nullable_issue_labels();
                if("".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))
                {
                    result.NullableIssueLabelsMember1 = new global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1();
                }
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(NullableIssueLabelsMember1 != null)
                {
                    return NullableIssueLabelsMember1.GetFieldDeserializers();
                }
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(NullableIssueLabelsMember1 != null)
                {
                    writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Nullable_issue_labelsMember1>(null, NullableIssueLabelsMember1);
                }
                else if(UnionBranch != null)
                {
