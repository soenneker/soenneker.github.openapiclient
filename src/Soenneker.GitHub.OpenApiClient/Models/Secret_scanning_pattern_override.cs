...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Secret_scanning_pattern_override : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_default_setting? DefaultSetting { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_enterprise_setting? EnterpriseSetting { get; set; }
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_setting? Setting { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override"/> and sets the default values.
        /// </summary>
        public Secret_scanning_pattern_override()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "default_setting", n => { DefaultSetting = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_default_setting>(); } },
                { "display_name", n => { DisplayName = n.GetStringValue(); } },
                { "enterprise_setting", n => { EnterpriseSetting = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_enterprise_setting>(); } },
                { "false_positive_rate", n => { FalsePositiveRate = n.GetIntValue(); } },
                { "false_positives", n => { FalsePositives = n.GetIntValue(); } },
                { "setting", n => { Setting = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_setting>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_default_setting>("default_setting", DefaultSetting);
            writer.WriteStringValue("display_name", DisplayName);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_enterprise_setting>("enterprise_setting", EnterpriseSetting);
            writer.WriteIntValue("false_positive_rate", FalsePositiveRate);
            writer.WriteIntValue("false_positives", FalsePositives);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_pattern_override_setting>("setting", Setting);
