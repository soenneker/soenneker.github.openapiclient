...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Classroom_assignment : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Simple_classroom_repository? StarterCodeRepository { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Simple_classroom_repository StarterCodeRepository { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "starter_code_repository", n => { StarterCodeRepository = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Simple_classroom_repository>(global::Soenneker.GitHub.OpenApiClient.Models.Simple_classroom_repository.CreateFromDiscriminatorValue); } },
                { "students_are_repo_admins", n => { StudentsAreRepoAdmins = n.GetBoolValue(); } },
                { "submitted", n => { Submitted = n.GetIntValue(); } },
                { "title", n => { Title = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Simple_classroom_repository>("starter_code_repository", StarterCodeRepository);
            writer.WriteBoolValue("students_are_repo_admins", StudentsAreRepoAdmins);
            writer.WriteIntValue("submitted", Submitted);
            writer.WriteStringValue("title", Title);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Classroom_assignment_type>("type", Type);
