...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Hook_delivery : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_request? Request { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_request Request { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_response? Response { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_response Response { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery"/> and sets the default values.
        /// </summary>
        public Hook_delivery()
        {
        ...
        public static global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "request", n => { Request = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_request>(global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_request.CreateFromDiscriminatorValue); } },
                { "response", n => { Response = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_response>(global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_response.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_request>("request", Request);
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Hook_delivery_response>("response", Response);
