...
namespace Soenneker.GitHub.OpenApiClient.Models
{
    ...
    public partial class Review_comment : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_links? Links { get; set; }
#nullable restore
#else
        public global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_links Links { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_side? Side { get; set; }
        /// <summary>The first line of the range for a multi-line comment.</summary>
        public int? StartLine { get; set; }
        /// <summary>The side of the first line of the range for a multi-line comment.</summary>
        public global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_start_side? StartSide { get; set; }
        /// <summary>The level at which the comment is targeted, can be a diff line or a file.</summary>
        public global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_subject_type? SubjectType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Review_comment"/> and sets the default values.
        /// </summary>
        public Review_comment()
        {
            AdditionalData = new Dictionary<string, object>();
            Side = global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_side.RIGHT;
            StartSide = global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_start_side.RIGHT;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Review_comment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.GitHub.OpenApiClient.Models.Review_comment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.GitHub.OpenApiClient.Models.Review_comment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "_links", n => { Links = n.GetObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_links>(global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_links.CreateFromDiscriminatorValue); } },
                ...
                { "side", n => { Side = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_side>(); } },
                { "start_line", n => { StartLine = n.GetIntValue(); } },
                { "start_side", n => { StartSide = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_start_side>(); } },
                { "subject_type", n => { SubjectType = n.GetEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_subject_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_links>("_links", Links);
            ...
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_side>("side", Side);
            writer.WriteIntValue("start_line", StartLine);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_start_side>("start_side", StartSide);
            writer.WriteEnumValue<global::Soenneker.GitHub.OpenApiClient.Models.Review_comment_subject_type>("subject_type", SubjectType);
