...
using Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.Item;
using Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.Users;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats
{
    /// <summary>
    ...
    public partial class TimeStatsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.Users.UsersRequestBuilder Users
        {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::Soenneker.GitHub.OpenApiClient.Models.Api_insights_time_stats_item&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::Soenneker.GitHub.OpenApiClient.Models.Api_insights_time_stats_item>?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder.TimeStatsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.GitHub.OpenApiClient.Models.Api_insights_time_stats_item>> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder.TimeStatsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.GitHub.OpenApiClient.Models.Api_insights_time_stats_item>(requestInfo, global::Soenneker.GitHub.OpenApiClient.Models.Api_insights_time_stats_item.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder.TimeStatsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder.TimeStatsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Insights.Api.TimeStats.TimeStatsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get the number of API requests and rate-limited requests made within an organization over a specified time period.
        /// </summary>
