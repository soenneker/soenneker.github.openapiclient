...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Models.Copilot_set_copilot_content_exclusion_for_organization_200"/></returns>
        ...
        /// <exception cref="global::Soenneker.GitHub.OpenApiClient.Models.Basic_error">When receiving a 403 status code</exception>
        /// <exception cref="global::Soenneker.GitHub.OpenApiClient.Models.Basic_error">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.GitHub.OpenApiClient.Models.Basic_error">When receiving a 413 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Copilot_set_copilot_content_exclusion_for_organization_200?> PutAsync(global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Copilot.Content_exclusion.Content_exclusionPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Copilot_set_copilot_content_exclusion_for_organization_200> PutAsync(global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Copilot.Content_exclusion.Content_exclusionPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "403", global::Soenneker.GitHub.OpenApiClient.Models.Basic_error.CreateFromDiscriminatorValue },
                { "404", global::Soenneker.GitHub.OpenApiClient.Models.Basic_error.CreateFromDiscriminatorValue },
                { "413", global::Soenneker.GitHub.OpenApiClient.Models.Basic_error.CreateFromDiscriminatorValue },
                { "422", global::Soenneker.GitHub.OpenApiClient.Models.Validation_error_simple.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.GitHub.OpenApiClient.Models.Basic_error.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.GitHub.OpenApiClient.Models.Copilot_set_copilot_content_exclusion_for_organization_200>(requestInfo, global::Soenneker.GitHub.OpenApiClient.Models.Copilot_set_copilot_content_exclusion_for_organization_200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &gt; [!NOTE]&gt; This endpoint is in public preview and is subject to change.Gets information about an organization&apos;s Copilot content exclusion path rules.To configure these settings, go to the organization&apos;s settings on GitHub.For more information, see &quot;[Excluding content from GitHub Copilot](https://docs.github.com/copilot/managing-copilot/configuring-and-auditing-content-exclusion/excluding-content-from-github-copilot#configuring-content-exclusions-for-your-organization).&quot;Organization owners can view details about Copilot content exclusion rules for the organization.OAuth app tokens and personal access tokens (classic) need either the `copilot` or `read:org` scopes to use this endpoint.&gt; [!CAUTION]&gt; * At this time, the API does not support comments. This endpoint will not return any comments in the existing rules.&gt; * At this time, the API does not support duplicate keys. If your content exclusion configuration contains duplicate keys, the API will return only the last occurrence of that key. For example, if duplicate entries are present, only the final value will be included in the response.
        /// </summary>
