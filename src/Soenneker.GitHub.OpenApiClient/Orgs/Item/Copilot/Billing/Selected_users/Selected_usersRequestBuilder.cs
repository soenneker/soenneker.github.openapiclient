...
#nullable enable
        public async Task<string?> DeleteAsync(global::Soenneker.GitHub.OpenApiClient.Models.CopilotCancelCopilotSeatAssignmentForUsers body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> DeleteAsync(global::Soenneker.GitHub.OpenApiClient.Models.CopilotCancelCopilotSeatAssignmentForUsers body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<string?> PostAsync(global::Soenneker.GitHub.OpenApiClient.Models.CopilotAddCopilotSeatsForUsers body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> PostAsync(global::Soenneker.GitHub.OpenApiClient.Models.CopilotAddCopilotSeatsForUsers body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
