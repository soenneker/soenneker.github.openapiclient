...
namespace Soenneker.GitHub.OpenApiClient.Orgs.Item.Outside_collaborators.Item
{
    ...
    public partial class WithUsernameItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.GitHub.OpenApiClient.Models.OrgsRemoveOutsideCollaborator422">When receiving a 422 status code</exception>
...
#nullable restore
        ...
        public async Task<Stream> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "422", global::Soenneker.GitHub.OpenApiClient.Models.OrgsRemoveOutsideCollaborator422.CreateFromDiscriminatorValue },
            };
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Outside_collaborators.Item.WithUsernamePutResponse?> PutAsync(global::Soenneker.GitHub.OpenApiClient.Models.OrgsConvertMemberToOutsideCollaborator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitHub.OpenApiClient.Orgs.Item.Outside_collaborators.Item.WithUsernamePutResponse> PutAsync(global::Soenneker.GitHub.OpenApiClient.Models.OrgsConvertMemberToOutsideCollaborator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Soenneker.GitHub.OpenApiClient.Models.OrgsConvertMemberToOutsideCollaborator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Soenneker.GitHub.OpenApiClient.Models.OrgsConvertMemberToOutsideCollaborator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
