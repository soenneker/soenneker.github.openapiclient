...
namespace Soenneker.GitHub.OpenApiClient.Repos.Item.Item.SecretScanning.Alerts.Item
{
    ...
    public partial class WithAlert_numberItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert503Error">When receiving a 503 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Repos.Item.Item.SecretScanning.Alerts.Item.WithAlert_numberItemRequestBuilder.WithAlert_numberItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Repos.Item.Item.SecretScanning.Alerts.Item.WithAlert_numberItemRequestBuilder.WithAlert_numberItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "503", global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert503Error.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendAsync<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert>(requestInfo, global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert?> PatchAsync(global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_update_alert body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_alert> PatchAsync(global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_update_alert body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_update_alert body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Soenneker.GitHub.OpenApiClient.Models.Secret_scanning_update_alert body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
