...
using Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.GitHub.OpenApiClient.User.Repository_invitations
{
    /// <summary>
    ...
    public partial class Repository_invitationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Item.WithInvitation_ItemRequestBuilder this[int position]
        {
            get
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Soenneker.GitHub.OpenApiClient.Models.Repository_invitation>?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder.Repository_invitationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Soenneker.GitHub.OpenApiClient.Models.Repository_invitation>> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder.Repository_invitationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Soenneker.GitHub.OpenApiClient.Models.Repository_invitation>(requestInfo, global::Soenneker.GitHub.OpenApiClient.Models.Repository_invitation.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder.Repository_invitationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder.Repository_invitationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitHub.OpenApiClient.User.Repository_invitations.Repository_invitationsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// When authenticating as a user, this endpoint will list all currently open repository invitations for that user.
        /// </summary>
