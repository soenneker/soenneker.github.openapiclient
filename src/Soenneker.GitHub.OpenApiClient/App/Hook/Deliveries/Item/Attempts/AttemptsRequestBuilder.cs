...
{
    /// <summary>
    /// Builds and executes requests for operations under \app\hook\deliveries\{deliveryId}\attempts
    /// </summary>
    ...
    public partial class AttemptsRequestBuilder : BaseRequestBuilder
    {
        ...
        public AttemptsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/hook/deliveries/{deliveryId}/attempts", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.App.Hook.Deliveries.Item.Attempts.AttemptsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AttemptsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/app/hook/deliveries/{deliveryId}/attempts", rawUrl)
        {
        }
        /// <summary>
