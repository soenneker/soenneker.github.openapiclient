...
{
    /// <summary>
    /// Builds and executes requests for operations under \users\{user-id}\docker\conflicts
    /// </summary>
    ...
    public partial class ConflictsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ConflictsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/docker/conflicts", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Users.Item.Docker.Conflicts.ConflictsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ConflictsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/users/{user%2Did}/docker/conflicts", rawUrl)
        {
        }
        /// <summary>
