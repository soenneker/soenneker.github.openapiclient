...
using Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.Item;
...
namespace Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces
{
    ...
    public partial class CopilotSpacesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/rest/copilot-spaces/copilot-spaces#create-a-copilot-space-for-a-user" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder.CopilotSpacesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder.CopilotSpacesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitHub.OpenApiClient.Users.Item.CopilotSpaces.CopilotSpacesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists Copilot Spaces owned by a user. The authenticated user must have read access to the user&apos;s Copilot Spaces.Only Spaces that are readable by the authenticated user are returned. This includes the user&apos;s own spaces, and public user spaces when accessing another user&apos;s spaces.OAuth app tokens and personal access tokens (classic) need the `read:user` scope to use this endpoint.
        /// </summary>
