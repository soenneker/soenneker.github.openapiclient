...
#nullable enable
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Activity_list_repos_starred_by_user_200?> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Users.Item.Starred.StarredRequestBuilder.StarredRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.GitHub.OpenApiClient.Models.Activity_list_repos_starred_by_user_200> GetAsync(Action<RequestConfiguration<global::Soenneker.GitHub.OpenApiClient.Users.Item.Starred.StarredRequestBuilder.StarredRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.GitHub.OpenApiClient.Models.Activity_list_repos_starred_by_user_200>(requestInfo, global::Soenneker.GitHub.OpenApiClient.Models.Activity_list_repos_starred_by_user_200.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &quot;Lists repositories a user has starred.This endpoint supports the following custom media types. For more information, see \&quot;[Media types](https://docs.github.com/rest/using-the-rest-api/getting-started-with-the-rest-api#media-types).\&quot;- **`application/vnd.github.star+json`**: Includes a timestamp of when the star was created.&quot;
        /// </summary>
