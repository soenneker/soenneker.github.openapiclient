...
using System;
namespace Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval
{
    /// <summary>
    /// Builds and executes requests for operations under \organizations\{org}\actions\permissions\fork-pr-contributor-approval
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ForkPrContributorApprovalRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval.ForkPrContributorApprovalRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForkPrContributorApprovalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/organizations/{org}/actions/permissions/fork-pr-contributor-approval", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval.ForkPrContributorApprovalRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ForkPrContributorApprovalRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/organizations/{org}/actions/permissions/fork-pr-contributor-approval", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval.ForkPrContributorApprovalRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval.ForkPrContributorApprovalRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.GitHub.OpenApiClient.Organizations.Item.Actions.Permissions.ForkPrContributorApproval.ForkPrContributorApprovalRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
